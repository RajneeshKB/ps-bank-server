...
const getUniqueCreditCardNumber = async () => {
	const newCreditCardNumber = getRandomIntInclusive(1234567890123456, 9876543210987654)
	const existingCreditCard = await CreditCard.findOne({creditCardNumber: newCreditCardNumber})
...
exports.issueNewCreditCardToDb = async ({creditCardData}, req) => {
	...
	try{
		...
		console.log('cought expection while applying for credit card', e)
